...
- Create Angular project with ng: `ng new ecommercefullstack.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`ecommercefullstack.client.esproj`).
